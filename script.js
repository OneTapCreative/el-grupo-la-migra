...
const translations = new Map([
  ...
  ['Travel availability is based on the date and event location. Add the exact service radius here once confirmed.','La disponibilidad para viajar depende de la fecha y ubicación del evento. Aquí agregaremos el área exacta de servicio cuando se confirme.'],
