...
const translations = new Map([
  ...
  ['CHECK YOUR DATE','VERIFICA TU FECHA'],
  ['Is Your Event Date Available?','¿Está Disponible La Fecha De Tu Evento?'],
  ['Send us your date, location, and event details and we’ll confirm availability for your celebration.','Envíanos la fecha, ubicación y detalles de tu evento y confirmaremos la disponibilidad para tu celebración.'],
  ['Check Your Date','Verificar Tu Fecha'],
  ...
  ['Years Performing','Años de Trayectoria'],
  ['Events Played','Eventos Realizados'],
  ['& Surrounding Areas','y Áreas Cercanas'],
  ...
  ['View All Service Areas','Ver Todas las Áreas de Servicio'],
  ['Do you provide sound equipment?','¿Proporcionan equipo de sonido?'],
  ['Sound and setup needs can vary by venue and event. We’ll confirm the equipment plan, power needs, and setup requirements with you before the booking is finalized.','Las necesidades de sonido y montaje pueden variar según el lugar y el evento. Confirmaremos contigo el equipo, la energía necesaria y los requisitos de montaje antes de finalizar la reservación.'],
  ['How much space does the group need?','¿Cuánto espacio necesita el grupo?'],
  ['Space requirements depend on the venue, event layout, and performance setup. Share your venue details in the quote form so we can confirm what will work best.','El espacio necesario depende del lugar, la distribución del evento y el montaje. Comparte los detalles del lugar en el formulario para confirmar qué funcionará mejor.'],
  ['How long do performances and breaks last?','¿Cuánto duran las presentaciones y los descansos?'],
  ['Performance length and break timing are arranged around the event schedule. Tell us the hours you need in the quote form and we’ll confirm the available format.','La duración de la presentación y los descansos se organizan según el horario del evento. Indica las horas que necesitas en el formulario y confirmaremos el formato disponible.'],
  ['Is a deposit required and what payment methods are accepted?','¿Se requiere depósito y qué métodos de pago aceptan?'],
  ['Deposit and payment details are confirmed with your quote before the booking is finalized, so you’ll know the terms before committing.','Los detalles del depósito y pago se confirman con la cotización antes de finalizar la reservación, para que conozcas los términos antes de comprometerte.'],
  ['Check Area','Ver Área'],
